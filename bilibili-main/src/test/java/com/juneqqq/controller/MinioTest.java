...
//        File f = File.createTempFile("mytmp",".mp4");
    ...
    @Test
    void selectFileInfo() {
        GetObjectResponse fileInfo = fileService.getFileInfoFromMinio("default", "289122f38986c8e16eaa4e561ec18059-Java学习路线汇总.pdf");
        System.out.println(fileInfo.headers().get("Content-Length"));
    }
